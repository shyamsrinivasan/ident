...
rxfname = 'C:\Users\shyam\Documents\Courses\CHE1125Project\IntegratedModels\KineticModel\ecoliT4.txt';
...
%     load('C:\Users\shyam\Documents\Courses\CHE1125Project\mat_files\KineticModel\ecoliT2_MC_4.mat');
    nmodels = 100;
    [ensb] = build_ensemble(nmodels,FBAmodel,parameter,variable.MC);
    %Resample Kms
    ensb = resample_ensemble(ensb,FBAmodel,variable);
% load('C:\Users\shyam\Documents\Courses\CHE1125Project\mat_files\KineticModel\ecoliT2_parameters_4.mat');
    inSolution = [];
