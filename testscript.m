...
load('C:\Users\shyam\Documents\Courses\CHE 1125 Project\Kinetic Model\lacOPm.mat');
...
trnfname = 'C:\Users\shyam\Documents\Courses\CHE 1125 Project\TRN Model\lacOPtrn.txt';
regfname = '';
...
[trnmodel,batch,solverP] = initializeModel(trnmodel,5000);
varname = {'A';'B';'C';'D';'E';'P';'P1';'P5'};   
saveData.filename = '';%sprintf('ExptCondition_%d',exptnum);
saveData.dirname = 'C:\Users\shyam\Documents\Courses\CHE 1125 Project\Results\TRN Model version 6';
%Solve Model ODE 
initSolution = struct([]);
...
sampleinitval(fname1,ng,varname,{},trnmodel,pName,pScale);
