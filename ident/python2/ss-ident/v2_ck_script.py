...
storage_file_name = os.path.join(os.getcwd(), 'ident/ident_v2')
...
# flux_ident_2_data_combination(arranged_data_df, flux_ids=[2], flux_choice=[0],
...
validation_file_name = os.path.join(os.getcwd(), 'validate/ident_validate_v2')
