...
def get_all_ident_experiments(ident_file_name, exp_file_name, max_number_experiments):
    ...
    ident_df = retrieve_experimental_data_from_file(ident_file_name, ident_index_label)
    ...
    for i_parameter, i_parameter_name in enumerate(all_parameter_names):
        ...
        for i_experiment, i_experiment_pos in enumerate(exp_column_ids):
            try:
                ...
                exp_frequency = pd.Series([0] * len(all_possible_experiments), index=all_possible_experiments)
