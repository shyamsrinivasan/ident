...
storage_file_name = os.path.join(os.getcwd(), 'ident/ident_v1_vmax')
...
# flux_ident_2_data_combination(arranged_data_df, flux_ids=[1], flux_choice=[1],
...
validation_file_name = os.path.join(os.getcwd(), 'validate\ident_validate_v1_vmax')
...
parameter_values_plot(all_parameter_info, violin=True, box=False)
