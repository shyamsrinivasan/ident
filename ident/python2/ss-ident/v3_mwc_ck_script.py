...
# use MWC model data for identifying CK model parameters
...
storage_file_name = os.path.join(os.getcwd(), 'ident/ident_v3_root_1_mwc_data')
...
validation_file_name = os.path.join(os.getcwd(), 'validate/ident_validate_v3_root_1_mwc_data')
...
# validation plot
original_experiment_file = os.path.join(os.getcwd(), 'exp/experiments_mwc')
