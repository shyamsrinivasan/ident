	...
	\begin{table}[!thbp]
		...
		\begin{center}				
			\begin{tabular}{lp{3.5cm}ccccc}
				\hline
				Experiment Type & Perturbed Parameter (wild type value a.u.)& \multicolumn{5}{c}{Perturbed Values}\\
				\hline
				wild type &  &\multicolumn{5}{l}{}\\
				acetate perturbation & $acetate$ (0.1) & 0.05 & 0.09 & 0.11 & 0.5 & 1.0\\
