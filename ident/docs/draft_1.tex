	...
	\begin{table}[!thbp]
		...
		\begin{center}				
			\begin{tabular}{llccccc}
				...
				\hline
				wild type & - & \multicolumn{5}{l}{$acetate$ = 0.1}\\
				\hline
				acetate perturbation & $acetate$ & 0.5 & 1.0 & & &\\
				\hline
				$v_1$ perturbation & $k_1^{cat}$ & 0.5 & 0.9 & 1.1 & 1.5 & 2.0 \\
				\hline
				$v_2$ perturbation & $V_2^{max}$ & 0.5 & 0.9 & 1.1 & 1.5 & 2.0 \\				
				\hline
				$v_3$ perturbation & $V_3^{max}$ & 0.5 & 0.9 & 1.1 & 1.5 & 2.0 \\
			\end{tabular}
		\end{center}	
		\label{tab:pval}
	\end{table}	
