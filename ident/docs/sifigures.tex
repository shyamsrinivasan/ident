...
\externaldocument{draft_4} % reference to existing external document
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=1.0\textheight, keepaspectratio]{figures/parameter_dist/v1_vmax_ck_parameter_values}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v1_kcat_ck_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=0.8\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v2_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v3_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v5_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v3_mwc_ck_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=1.0\textheight, keepaspectratio]{figures/ident_exp_info/v1_vmax_exp_info}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.6\textheight, keepaspectratio]{figures/ident_exp_info/v3_ck_exp_info}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.6\textheight, keepaspectratio]{figures/ident_exp_info/v3_mwc_ck_exp_info}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v3_var_k3fdp_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.8\textheight, keepaspectratio]{figures/parameter_dist/v3_var_k3pep_parameter_dist}}
...
\begin{figure}[!tbhp]
	\centering{\includegraphics[width=1.0\textwidth,height=0.3\textheight, keepaspectratio]{figures/ident_exp_info/v3_var_exp_info}}
