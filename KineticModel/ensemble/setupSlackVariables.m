...
lb_slack(lb_slack==0) = 0.08 ;%1.3201;%5e-1;
%-------
% vpgi = strcmpi(newmodel.rxns,'pgi');
% lb_slack(vpgi) = 3;
% vpfk = strcmpi(newmodel.rxns,'pfk');
% lb_slack(vpfk) = 2;
lb_slack(strcmpi(newmodel.rxns,'fba')) = 0.1;
lb_slack(strcmpi(newmodel.rxns,'atps4r')) = 10;
% lb_slack(strcmpi(newmodel.rxns,'pgk')) = 2;
lb_slack(strcmpi(newmodel.rxns,'tpi')) = 0.1;
lb_slack(strcmpi(newmodel.rxns,'me1')) = 0.1;
