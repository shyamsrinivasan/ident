...
if status == 1    
    load('C:/Users/shyam/Documents/Courses/CHE1125Project/IntegratedModels/KineticModel/estimation/ident/mle/mle_nn_sep13');
elseif status == 2    
    load('~/Documents/Courses/CHE1125Project/IntegratedModels/KineticModel/estimation/ident/mle/mle_nn_sep13');    
end
...
thetai_fixed_value = MLE_no_noise.mle_pval(11);
theta_step = 0;
