...
% fname = 'simest_noisy_pep_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf1);
% set(0,'CurrentFigure',hf2);
% fname = 'simest_noisy_fdp_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf2);
% set(0,'CurrentFigure',hf3);
% fname = 'simest_noisy_enz_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf3);
% set(0,'CurrentFigure',hf4);
% fname = 'simest_noisy_v1_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf4);
% set(0,'CurrentFigure',hf5);
% fname = 'simest_noisy_v2_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf5);
% set(0,'CurrentFigure',hf6);
% fname = 'simest_noisy_v3_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf6);
% set(0,'CurrentFigure',hf7);
% fname = 'simest_noisy_pep_scatter_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf7);
% set(0,'CurrentFigure',hf8);
% fname = 'simest_noisy_fdp_scatter_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf8);
% set(0,'CurrentFigure',hf9);
% fname = 'simest_noisy_enz_scatter_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf9);
% set(0,'CurrentFigure',hf10);
% fname = 'simest_noisy_v1_scatter_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf10);
% set(0,'CurrentFigure',hf11);
% fname = 'simest_noisy_v2_scatter_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf11);
% set(0,'CurrentFigure',hf12);
% fname = 'simest_noisy_v3_scatter_aug31';
% print([dir fname],'-depsc','-painters','-loose','-tiff','-r200');
% print([dir fname],'-dpng','-r200');
% close(hf12);
