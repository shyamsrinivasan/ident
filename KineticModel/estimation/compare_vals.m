...
npert = data.npert;
nflx = data.nflx;
flx_vec = [zeros(length(1:flxid-1),npert);...
            opt_fss_avg;zeros(length(flxid+1:nflx),npert)];
ferr_vec = [zeros(length(1:flxid-1),npert);...
            opt_fss_err;zeros(length(flxid+1:nflx),npert)];
