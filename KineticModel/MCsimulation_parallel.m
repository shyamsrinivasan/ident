...
if status >= 0
    ...
    for isamp = 1:nsamples
        ...
        [model,batch,solverP,saveData] = initializeModel(model,800);
...
printvar = {'Pin','P1','P2','P3','P4','P5','P6','P10','P11','Pout','Bout','Aout','BiomassEX'};
% printvar = {'Pin','P1','P2','P3','P4','P5','P6','Pout','Dout','Eout','BiomassEX'};
