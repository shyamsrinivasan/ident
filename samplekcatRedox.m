...
pvec.K(nadph,vred(1)) = mc(nadph)/sb_rat;
...
pvec.K(nadph,vred(3)) = mc(nadph)/sb_rat;
pr_rat = sigma(2)/(1-sigma(2));
pvec.K(nadp,vred(3)) = mc(nadp)/pr_rat;
...
sigma = rand(2,1);
sb_rat = sigma(1)/(1-sigma(1));
pvec.K(nad,vred(4)) = mc(nad)/sb_rat;
pr_rat = sigma(2)/(1-sigma(2));
pvec.K(nadh,vred(4)) = mc(nadh)/pr_rat;
...
sigma = rand(2,1);
sb_rat = sigma(1)/(1-sigma(1));
pvec.K(atp,vred(5)) = mc(atp)/sb_rat;
pr_rat = sigma(2)/(1-sigma(2));
pvec.K(adp,vred(5)) = mc(adp)/pr_rat;
