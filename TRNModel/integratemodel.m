function [Solution] = integratemodel(trnmodel,ngene,tnreg,ngap,InConc,tspan,initval)
%==========================================================================
%Initial Value for mRNA and protein concnetration
if nargin < 7 || length(initval) ~= ngene+tnreg
    initval = ones(ngene+tnreg,1);
    initval = initval/(1E-15*6.023E+23);
end

[t,dY] = ode23(@matbalance,tspan,initval);
Solution.time = t;
