% perturb every point on the 1-D unstable manifold to see which side
% reflects the basin of attraction of different stable equilibrium points

% get unstable manifold
...
% perturb manifold
perturbManifolds(xWus',saddle,model,pvec,opts,tspanf,hfig,[1 2 3],10);